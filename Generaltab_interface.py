...
check_marked = tk.BooleanVar(value=False)
...
person_combo = ttk.Checkbutton(case_information_frame, text="Yes", variable=check_marked) 
person_combo.grid(row=8, column=1, padx=5, pady=5)
person_combo = ttk.Checkbutton(case_information_frame, text="No", variable=check_marked)
person_combo.grid(row=8, column=2, padx=5, pady=5)
person_combo = ttk.Checkbutton(case_information_frame, text="Not Interested", variable=check_marked) 
person_combo.grid(row=8, column=3, padx=5, pady=5)
person_combo = ttk.Checkbutton(case_information_frame, text="Maybe", variable=check_marked) 
person_combo.grid(row=9, column=1, padx=5, pady=5)
person_combo = ttk.Checkbutton(case_information_frame, text="Not sure", variable=check_marked)
person_combo.grid(row=9, column=2, padx=5, pady=5)
person_combo = ttk.Checkbutton(case_information_frame, text="Interested", variable=check_marked) 
person_combo.grid(row=9, column=3, padx=5, pady=5)
person_combo = ttk.Checkbutton(case_information_frame, text="Denied", variable=check_marked)
person_combo.grid(row=10, column=1, padx=5, pady=5)
...
client_referral = ttk.Checkbutton(insurance_information_frame, variable=check_marked) 
