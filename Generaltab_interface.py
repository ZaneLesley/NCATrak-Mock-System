...
ttk.Label(mdt_frame, text="Case Tracking").pack()
...
ttk.Button(codes_frame, text="+ Add New Point of Contact", command=add_code_record_popup).grid(row=0, column=0, padx=5, pady=5, sticky="w")
